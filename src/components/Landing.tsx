...
const STEPS = [
  { n: 1, title: "Create an account", body: "Register in seconds and top up with a quick deposit." },
  ...
  return (
    <div className="w-full">
      ...
      <section className="px-4 pb-14 pt-6">
        <div className="mx-auto flex max-w-5xl flex-col items-center text-center">
          ...
          <h1 className="mt-5 font-display text-3xl font-extrabold leading-tight text-white sm:text-5xl">
            Predict. Play. <span className="text-mega-gold">Win Big.</span>
          </h1>
      ...
      <section className="px-4 pb-28 pt-4">
        <div className="mx-auto max-w-4xl">
          <div className="overflow-hidden rounded-2xl bg-[#798DFE] p-8 text-center shadow-[0_1px_2px_rgba(17,17,17,0.1)]">
            <TrophyIcon className="mx-auto h-10 w-10 text-mega-gold" />
            <h3 className="mt-3 font-display text-2xl font-extrabold text-white">Ready to play?</h3>
            <p className="mt-1 text-sm font-medium text-white/90">Join Mega 99 and start predicting today.</p>
            <Link href="/register" className="btn-green mx-auto mt-5 inline-flex !px-8 !py-4 text-base">
              Create free account
            </Link>
          </div>

          <footer className="mt-8 flex flex-col items-center gap-2 border-t border-white/15 pt-6 text-center">
            <BrandLogo size={40} />
            <div className="font-display text-sm font-extrabold text-white">MEGA 99</div>
  ...
  return (
    <section className="px-4 py-8">
      <div className="mx-auto mb-5 max-w-5xl text-center">
        <div className="text-xs font-bold uppercase tracking-widest text-mega-gold">{subtitle}</div>
