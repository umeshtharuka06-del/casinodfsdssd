 ...
 * Pure inline SVG (no extra deps), so it stays crisp at any size and inherits
 * the surrounding font size via `em`. This is the original pre-redesign gold
 * appearance (face #f6b738, highlight #ffe08a, deep #d98a14).
 */
