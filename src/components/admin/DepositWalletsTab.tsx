    ...
    <div className="space-y-5">
      ...
      <div className="card p-4 md:p-5">
        <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
          <h3 className="text-sm font-bold text-[#111111]">Deposit wallets</h3>
        ...
        {/* Add form */}
        <div className="mb-4 grid gap-2 rounded-xl bg-[#FFF6CC] p-3 sm:grid-cols-[1fr_2fr_auto_auto]">
          <input
                ...
                <tr key={w.id}>
                  ...
                  <td className="pr-3">
                    <button
                      ...
                      className={`chip ${w.active ? "bg-game-green/15 text-game-green" : "bg-black/5 text-slate-400"}`}
                    >
      ...
      {/* Payment settings */}
      <div className="card p-4 md:p-5">
        <h3 className="mb-4 text-sm font-bold text-[#111111]">Payment settings</h3>
