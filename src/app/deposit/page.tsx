    ...
    <div className="space-y-4 py-2">
      <div className="flex items-center justify-between">
        <h1 className="flex items-center gap-2 text-lg font-black text-[#1D1D1F]">
          <RechargeIcon className="h-5 w-5 text-royal-blue-bright" /> Deposit USDT
        </h1>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <div className="mt-3 w-full">
                ...
                <div className="mt-1 flex items-center gap-2">
                  <code className="flex-1 break-all rounded-lg bg-[#FFF6CC] px-3 py-2 text-xs text-slate-200">
                    {cfg.wallet.address}
                  </code>
            ...
            <div>
              ...
              {amount != null && amount > 0 && (
                <div className="mt-1 flex items-center gap-1 text-xs text-slate-400">
                  ...
                  <b className="text-game-gold">{coins(amount * cfg.coinsPerUsdt)}</b> coins
                </div>
              )}
            </div>
          ...
          <div className="card p-4">
            ...
            {deposits.length === 0 ? (
              ...
              <div className="divide-y divide-black/5">
                {deposits.map((d) => {
                  const st = STATUS[d.status] ?? { label: d.status, cls: "bg-black/5 text-slate-400" };
                  return (
                        ...
                        <div className="flex items-center gap-1 text-sm font-semibold">
                          ...
                          {d.status === "APPROVED" && (
                            <span className="flex items-center gap-1 text-game-green">
                              · +<CoinIcon className="text-game-gold" /> {coins(d.coinsFmt)}
                            </span>
                          )}
                        </div>
