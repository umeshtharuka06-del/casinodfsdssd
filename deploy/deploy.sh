...
#   ./deploy/deploy.sh local-db   # same, plus the optional bundled PostgreSQL
#
...
# Idempotent: prisma migrate deploy applies only not-yet-applied migrations
# from prisma/migrations and never generates or resets anything.
